...
openstack user create --domain Sales --project Finance --project-domain Sales --password redhat john
openstack user create --domain Sales --project Finance --project-domain Sales --password redhat collin 
